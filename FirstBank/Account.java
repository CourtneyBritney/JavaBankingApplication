...
public class Account {
    ...
    void deposit(int amount) {
        if (amount != 0) {
            balance = balance + amount;    //Depositing Cash, Adding to the current amount.
    ...
    void withdraw(int amount) {
        if (amount != 0) {
            ...
            previousTransaction = -amount;  //Withdrawing cash.
        }
    }
    ...
    do {
        ...
        switch(option) {
            ...
            case 'D': 
                ...
                System.out.println();
                break;
            //Case 'E' calculates the interest based on years
            case 'E':
